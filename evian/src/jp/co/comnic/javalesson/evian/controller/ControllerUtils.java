...
public class ControllerUtils {
	 ...
	 * の完全修飾名は「jp.co.comnic.javalesson.evian.entity.employee」となる。
	...
	public static String getFullyQualifiedClassName(String servletPath) {
		...
		String packageName = "jp.co.comnic.javalesson.evian.entity.";
...
//			ConvertUtils.register(new DepartmentConverter(), Department.class);
	 ...
	 */
//	private static class DepartmentConverter implements Converter {
//
//		@Override
...
//			try {
//				
//				department = departmentClass.cast(
//						new DepartmentDao().findById(Integer.parseInt((String)value)));
//				
